...
This app scans the Community store and the Athom store for all your installed apps and checks the version numbers in both release and test.
You can set an option to notify you in the Timeline once per day or you can manually check in the configuration page.
You can specify the time at which the update checks are performed each day.
